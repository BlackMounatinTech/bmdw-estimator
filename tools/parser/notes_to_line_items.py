...
def generate_clarifying_questions(quick_notes: str) -> dict:
    ...
    system = (
        ...
        "crush. If he says 'lock block' — that's a lock block. 'Blast rock' is the "
        "same product as 3 ft+ rip rap (catalogue_key rip_rap_3plus_uplands, $28/ton) — "
        "interchangeable, never ask to clarify. NEVER ask 'are you specifying 3/4\" "
        "clean crush no fines?' or similar pedantic spec questions. Treat his terms "
        "as authoritative.\n"
        ...
        "- CUSTOM MATERIAL DETAILS — when Michael mentions a non-standard material "
        "or item that isn't in the catalogue (e.g. 'maple tree', 'pavers from "
        "the garden centre', 'flagstone'), ALWAYS ask the supplier-and-delivery "
        "trio: (1) which specific supplier (Home Depot vs garden supply vs nursery vs "
        "etc. — different prices); (2) who picks up / who delivers (BMDW pickup, "
