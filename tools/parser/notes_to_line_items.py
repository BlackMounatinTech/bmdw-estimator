...
def generate_clarifying_questions(quick_notes: str) -> dict:
    ...
    system = (
        ...
        "- Compaction. ALL depths Michael states are COMPACTED depths by default. "
        "If he says '3 inches deep' that means 3 inches compacted. NEVER ask 'is that "
        "compacted or loose?'. Only ask about compaction if he explicitly says 'loose fill'.\n"
