    ...
    if st.button("Send Quote + Plan", use_container_width=True, disabled=not _email_ready,
        ...
        result = send_email(
            ...
            body_text=(
                ...
                f"Ready to go? Just reply \"yes\" and I'll get you on the schedule. Once you're "
                f"locked in, I'll send the deposit details to confirm your start date.\n\n"
                f"Quote is valid for {COMPANY.get('quote_validity_days', 60)} days. "
                f"Any questions, just reply.\n\n"
                f"For more information, take a look at our website: {COMPANY.get('website', '')}\n\n"
